...
import { Sparkles, Loader2, Check, Copy, ChevronDown, Send, MessageCircle, RotateCw, HelpCircle, Upload, X, Image as ImageIcon, Search, AlertTriangle, CheckCircle2 } from 'lucide-react';
