...
import { getScenes, getShots, createShot, updateShot, deleteShot, updateScene, createScene, deleteScene, updateProject, createImageVariant, getImageVariants, getUserCredits, getCharacters, getObjects, getStagedImages, updateProjectImage, reorderShots, removeImageFromShot } from '../services/api';
import { useProjectContext } from '../components/ProjectLayout';
import { Plus, Check, Edit2, Trash2, ChevronDown, ChevronRight, FileText, Clock, Maximize2, Minimize2, Sparkles, Settings } from 'lucide-react';
...
const ShotBoardPage: React.FC = () => {
    ...
    const [readinessDialogueShotId] = useState<number | null>(null);
    const [readinessDialogueScore] = useState(0);
    ...
    const handleDndAssignImage = async (_imageId: number, imageUrl: string, shotId: number) => {
