...
- **Project-Wide Style & Continuity** — Your project DNA (style, mood, cinematography, lighting, color palette) flows through every phase — from Creative Director conversations to scene planning to prompt compilation to quality analysis. Character bibles, object references, and scene context are maintained across shots so shot 47 stays visually consistent with shot 3. Cohesion checks and gap analysis catch drift before it becomes a problem.
...
- **Quality analysis with remediation** — Multi-dimension scoring across realism, style consistency, AI artifacts, character identity, and more — with intelligent strategy picking that maps specific issues to specific model fixes
